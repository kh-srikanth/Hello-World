...
left outer join [PostgreSQL_Clictell].[clictell].[public].[users] d with (nolock) on a.username = d.username
where c.r2r_dealer_id in (5202, 19204, 21827) and b.claim_type_id = 1 and d.username is null
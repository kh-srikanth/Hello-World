...
select 
	...
	, null as list_id
	, a.pages_list
	, is_email_suppressed as do_not_email
	, (Case when is_lime_opted_in = 0 then 1 else 0 end) as do_not_sms
	, 0 as do_not_phone
	...
	, a.created_by 
	, a.updated_dt
	, Isnull(a.updated_by, 'sa') as updated_by
	, 0 as lead_status_id
...
and c.customer_id is null and lower(b.accountstatus) = 'active' 
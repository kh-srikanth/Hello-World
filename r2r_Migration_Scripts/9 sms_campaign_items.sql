...
select 
	...
	, a.updated_dt
	, a.updated_by
	, Isnull(a.flow_id, 0) as flow_id -- need to check
	, 0 as is_seed
	, null as appt_sch_dt
	, a.campaign_item_id
...
left outer join sms.campaign_items f with (nolock) on a.campaign_item_id = f.r2r_campaignitem_id and c.campaign_id = f.campaign_id

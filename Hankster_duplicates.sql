select * 
from auto_customers.customer.customers (nolock) where is_deleted =0 and account_id = '42FDCA67-E5D5-4B3D-8DF2-FCCBBA08A244'

select * from auto_customers.portal.account with (nolock) where _id = '489436CB-731A-4647-A26F-24BBD7034D28'
...
from auto_customers.customer.customers (nolock) where is_deleted =0 and account_id = '489436CB-731A-4647-A26F-24BBD7034D28'
...
where 
a.is_deleted =0 
and a.account_id = '489436CB-731A-4647-A26F-24BBD7034D28'
...
select * from #temp2 order by phone,primary_email

select * from #temp2 where rnk >1 and vehicles is null--10718
...
from auto_customers.customer.customers (nolock) 
where account_id = '489436CB-731A-4647-A26F-24BBD7034D28'

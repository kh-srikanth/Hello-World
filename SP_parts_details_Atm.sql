...
select distinct  id, [Key_id], [Key1] ,orderNumber
		,(select [value] from #temp20 b where a.[key_id] = b.[Key_id] and a.[Key1] = b.[key1] and b.[key] = 'priceCode') as priceCode
		,(select [value] from #temp20 b where a.[key_id] = b.[Key_id] and a.[Key1] = b.[key1] and b.[key] = 'chargeAmount') as chargeAmount

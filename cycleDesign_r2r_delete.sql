...
select * into #vehicles from auto_customers.customer.vehicles a (nolock) where account_id = 'E2A9BEE6-A8D3-43AE-B975-FCCC15A7C95A' 
select * into #customers from auto_customers.customer.customers a (nolock) where  account_id = 'E2A9BEE6-A8D3-43AE-B975-FCCC15A7C95A' and  r2r_customer_id is not null  




--select count(*) from auto_customers.customer.customers where account_id = 'E2A9BEE6-A8D3-43AE-B975-FCCC15A7C95A' and lead_status_id is null and is_subscriber =1 
...
--select vin,customer_id from #vehicles where 
	account_id = 'E2A9BEE6-A8D3-43AE-B975-FCCC15A7C95A' and is_deleted =0 and is_valid_vin =1 and
customer_id not in (select customer_id from #customers where account_id = 'E2A9BEE6-A8D3-43AE-B975-FCCC15A7C95A' and is_deleted =0)
...
update  #customers set is_deleted =1 where account_id = 'E2A9BEE6-A8D3-43AE-B975-FCCC15A7C95A' and is_deleted =0 and  
...
update #vehicles set is_deleted =1 where 
--select vin,customer_id from #vehicles where 
	account_id = 'E2A9BEE6-A8D3-43AE-B975-FCCC15A7C95A' and is_deleted =0  and
customer_id not in (select customer_id from #customers where account_id = 'E2A9BEE6-A8D3-43AE-B975-FCCC15A7C95A' and is_deleted =0)
...
from #customers a where is_deleted  =0 and account_id ='E2A9BEE6-A8D3-43AE-B975-FCCC15A7C95A' and primary_phone_number_valid =1 and len(primary_phone_number) > 10  
...
from #customers a where is_deleted  =0 and account_id ='E2A9BEE6-A8D3-43AE-B975-FCCC15A7C95A' and secondary_phone_number_valid =1 and len(secondary_phone_number) > 10  


/*select primary_phone_number, count(*) from #customers where account_id = 'E2A9BEE6-A8D3-43AE-B975-FCCC15A7C95A' and primary_phone_number_valid =1 and 
...
customer_id not in (select customer_id from #vehicles where is_deleted =0  )
and is_deleted  =0
and account_id ='E2A9BEE6-A8D3-43AE-B975-FCCC15A7C95A'
) as a 
where rnk <> 1 
)
...
select is_deleted,* from #customers where is_deleted =0 and account_id  ='E2A9BEE6-A8D3-43AE-B975-FCCC15A7C95A' and customer_id in (72723,77007)
select is_deleted,* from #vehicles where is_deleted =0 and account_id  ='E2A9BEE6-A8D3-43AE-B975-FCCC15A7C95A' and customer_id in (72723,77007)
*/
...
from #customers where is_deleted =0 and account_id ='E2A9BEE6-A8D3-43AE-B975-FCCC15A7C95A' and (primary_phone_number_valid =1 or secondary_phone_number_valid =1) and 
...
where is_deleted =0  and account_id = 'E2A9BEE6-A8D3-43AE-B975-FCCC15A7C95A'
...
/*
select secondary_phone_number, count(*) from #customers where is_deleted =0 and account_id = 'E2A9BEE6-A8D3-43AE-B975-FCCC15A7C95A' and secondary_phone_number_valid=1 group by secondary_phone_number having count(*) > 1
select primary_phone_number, count(*) from #customers where is_deleted =0 and account_id = 'E2A9BEE6-A8D3-43AE-B975-FCCC15A7C95A' and primary_phone_number_valid=1 group by primary_phone_number having count(*) > 1

select customer_id,primary_phone_number,secondary_phone_number,primary_email from #customers where is_deleted =0 and account_id = 'E2A9BEE6-A8D3-43AE-B975-FCCC15A7C95A' and primary_phone_number in (
select primary_phone_number from #customers where is_deleted =0 and account_id = 'E2A9BEE6-A8D3-43AE-B975-FCCC15A7C95A' and primary_phone_number_valid=1 group by primary_phone_number having count(*) > 1
)
...
select * from auto_customers.customer.vehicles where is_deleted =0 and account_id = 'E2A9BEE6-A8D3-43AE-B975-FCCC15A7C95A' and is_valid_vin =1 and 
vin not in (select vin from #vehicles where is_deleted =0 and account_id = 'E2A9BEE6-A8D3-43AE-B975-FCCC15A7C95A' and is_valid_vin =1)


select count(*) from auto_customers.customer.customers where is_deleted =0 and account_id = 'E2A9BEE6-A8D3-43AE-B975-FCCC15A7C95A' and 
primary_phone_number not in (select primary_phone_number from #customers where is_deleted =0 and account_id = 'E2A9BEE6-A8D3-43AE-B975-FCCC15A7C95A')

select count(*) from auto_customers.customer.customers where is_deleted =0 and account_id = 'E2A9BEE6-A8D3-43AE-B975-FCCC15A7C95A' and 
secondary_phone_number not in (select secondary_phone_number from #customers where is_deleted =0 and account_id = 'E2A9BEE6-A8D3-43AE-B975-FCCC15A7C95A')

--missing valid primary_email due to eliminating duplicate phone numbers
select customer_id,primary_email,primary_email_valid from auto_customers.customer.customers where is_deleted =0 and account_id = 'E2A9BEE6-A8D3-43AE-B975-FCCC15A7C95A' and 
primary_email not in (select primary_email from #customers where is_deleted =0 and account_id = 'E2A9BEE6-A8D3-43AE-B975-FCCC15A7C95A') and primary_email_valid =1
...
update #customers set is_deleted = 0 where customer_id in (
select customer_id from auto_customers.customer.customers a where is_deleted =0 and account_id = 'E2A9BEE6-A8D3-43AE-B975-FCCC15A7C95A' and 
reverse(left(reverse(primary_phone_number),10)) not in (select primary_phone_number from #customers b where is_deleted =0 and account_id = 'E2A9BEE6-A8D3-43AE-B975-FCCC15A7C95A')
)
...
where a.account_id = 'E2A9BEE6-A8D3-43AE-B975-FCCC15A7C95A' and a.is_deleted =0 and b.is_deleted =1
...
--COUNTS
select count(*) from #customers where is_deleted =0 and account_id = 'E2A9BEE6-A8D3-43AE-B975-FCCC15A7C95A' --78
select count(*) from auto_customers.customer.customers (nolock) where is_deleted =0 and account_id = 'E2A9BEE6-A8D3-43AE-B975-FCCC15A7C95A' --5712


select count(*) from #vehicles where is_deleted =0 and account_id = 'E2A9BEE6-A8D3-43AE-B975-FCCC15A7C95A' --2576
select count(*) from auto_customers.customer.vehicles (nolock) where is_deleted =0 and account_id = 'E2A9BEE6-A8D3-43AE-B975-FCCC15A7C95A' --2622



select * from auto_customers.customer.customers a where is_deleted =0 and account_id = 'E2A9BEE6-A8D3-43AE-B975-FCCC15A7C95A' and r2r_customer_id is not null and 
reverse(left(reverse(primary_phone_number),10)) not in (select primary_phone_number from #customers b where is_deleted =0 and account_id = 'E2A9BEE6-A8D3-43AE-B975-FCCC15A7C95A')

select count(*) from auto_customers.customer.customers where is_deleted =0 and account_id = 'E2A9BEE6-A8D3-43AE-B975-FCCC15A7C95A' and  r2r_customer_id is not null and
secondary_phone_number not in (select secondary_phone_number from #customers where is_deleted =0 and account_id = 'E2A9BEE6-A8D3-43AE-B975-FCCC15A7C95A')

--missing valid primary_email due to eliminating duplicate phone numbers
select customer_id,primary_email,primary_email_valid from auto_customers.customer.customers where is_deleted =0 and account_id = 'E2A9BEE6-A8D3-43AE-B975-FCCC15A7C95A' and r2r_customer_id is not null and
primary_email not in (select primary_email from #customers where is_deleted =0 and account_id = 'E2A9BEE6-A8D3-43AE-B975-FCCC15A7C95A') and primary_email_valid =1
...
select * from auto_customers.customer.customers where is_deleted =0 and account_id = 'E2A9BEE6-A8D3-43AE-B975-FCCC15A7C95A' and first_name like 'zander' 

select * from auto_customers.customer.vehicles where is_deleted =0 and account_id = 'E2A9BEE6-A8D3-43AE-B975-FCCC15A7C95A' and customer_id in (42913
,42914)

update a set  is_deleted =1 
from auto_customers.customer.customers a (nolock) where is_deleted =0 and account_id = 'E2A9BEE6-A8D3-43AE-B975-FCCC15A7C95A' and customer_id = 42913
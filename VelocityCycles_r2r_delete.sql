...
select * into #vehicles from auto_customers.customer.vehicles a (nolock) where account_id = 'F0590E45-19AA-4597-A2B5-67553DD7B113'
select * into #customers from auto_customers.customer.customers a (nolock) where  account_id = 'F0590E45-19AA-4597-A2B5-67553DD7B113' and  r2r_customer_id is not null  


--select count(*) from auto_customers.customer.customers where account_id = 'F0590E45-19AA-4597-A2B5-67553DD7B113' and lead_status_id is null and is_subscriber =1 
...
and a.account_id = 'F0590E45-19AA-4597-A2B5-67553DD7B113'
) as a 
where rnk <> 1)
...
--select vin,customer_id from #vehicles where 
	account_id = 'F0590E45-19AA-4597-A2B5-67553DD7B113' and is_deleted =0 and is_valid_vin =1 and
customer_id not in (select customer_id from #customers where account_id = 'F0590E45-19AA-4597-A2B5-67553DD7B113' and is_deleted =0)
...
update  auto_customers.customer.customers set is_deleted =1 where account_id = 'F0590E45-19AA-4597-A2B5-67553DD7B113' and is_deleted =0 and  
...
update #vehicles set is_deleted =1 where 
--select vin,customer_id from #vehicles where 
	account_id = 'F0590E45-19AA-4597-A2B5-67553DD7B113' and is_deleted =0  and
customer_id not in (select customer_id from #customers where account_id = 'F0590E45-19AA-4597-A2B5-67553DD7B113' and is_deleted =0)
...
from #customers a where is_deleted  =0 and account_id ='F0590E45-19AA-4597-A2B5-67553DD7B113' and primary_phone_number_valid =1 and len(primary_phone_number) > 10  
...
from #customers a where is_deleted  =0 and account_id ='F0590E45-19AA-4597-A2B5-67553DD7B113' and secondary_phone_number_valid =1 and len(secondary_phone_number) > 10  


/*select primary_phone_number, count(*) from #customers where account_id = 'F0590E45-19AA-4597-A2B5-67553DD7B113' and primary_phone_number_valid =1 and 
...
customer_id not in (select customer_id from #vehicles where is_deleted =0  )
and is_deleted  =0
and account_id ='F0590E45-19AA-4597-A2B5-67553DD7B113'
) as a 
where rnk <> 1 
)
...
select is_deleted,* from #customers where is_deleted =0 and account_id  ='F0590E45-19AA-4597-A2B5-67553DD7B113' and customer_id in (72723,77007)
select is_deleted,* from #vehicles where is_deleted =0 and account_id  ='F0590E45-19AA-4597-A2B5-67553DD7B113' and customer_id in (72723,77007)
*/
...
from #customers where is_deleted =0 and account_id ='F0590E45-19AA-4597-A2B5-67553DD7B113' and (primary_phone_number_valid =1 or secondary_phone_number_valid =1) and 
...
where is_deleted =0  and account_id = 'F0590E45-19AA-4597-A2B5-67553DD7B113'
...
/*
select secondary_phone_number, count(*) from #customers where is_deleted =0 and account_id = 'F0590E45-19AA-4597-A2B5-67553DD7B113' and secondary_phone_number_valid=1 group by secondary_phone_number having count(*) > 1
select primary_phone_number, count(*) from #customers where is_deleted =0 and account_id = 'F0590E45-19AA-4597-A2B5-67553DD7B113' and primary_phone_number_valid=1 group by primary_phone_number having count(*) > 1

select customer_id,primary_phone_number,secondary_phone_number,primary_email from #customers where is_deleted =0 and account_id = 'F0590E45-19AA-4597-A2B5-67553DD7B113' and primary_phone_number in (
select primary_phone_number from #customers where is_deleted =0 and account_id = 'F0590E45-19AA-4597-A2B5-67553DD7B113' and primary_phone_number_valid=1 group by primary_phone_number having count(*) > 1
)
...
select * from auto_customers.customer.vehicles where is_deleted =0 and account_id = 'F0590E45-19AA-4597-A2B5-67553DD7B113' and is_valid_vin =1 and 
vin not in (select vin from #vehicles where is_deleted =0 and account_id = 'F0590E45-19AA-4597-A2B5-67553DD7B113' and is_valid_vin =1)


select count(*) from auto_customers.customer.customers where is_deleted =0 and account_id = 'F0590E45-19AA-4597-A2B5-67553DD7B113' and 
primary_phone_number not in (select primary_phone_number from #customers where is_deleted =0 and account_id = 'F0590E45-19AA-4597-A2B5-67553DD7B113')

select count(*) from auto_customers.customer.customers where is_deleted =0 and account_id = 'F0590E45-19AA-4597-A2B5-67553DD7B113' and 
secondary_phone_number not in (select secondary_phone_number from #customers where is_deleted =0 and account_id = 'F0590E45-19AA-4597-A2B5-67553DD7B113')

--missing valid primary_email due to eliminating duplicate phone numbers
select customer_id,primary_email,primary_email_valid from auto_customers.customer.customers where is_deleted =0 and account_id = 'F0590E45-19AA-4597-A2B5-67553DD7B113' and 
primary_email not in (select primary_email from #customers where is_deleted =0 and account_id = 'F0590E45-19AA-4597-A2B5-67553DD7B113') and primary_email_valid =1
...
update #customers set is_deleted = 0 where customer_id in (
select customer_id from auto_customers.customer.customers a where is_deleted =0 and account_id = 'F0590E45-19AA-4597-A2B5-67553DD7B113' and 
reverse(left(reverse(primary_phone_number),10)) not in (select primary_phone_number from #customers b where is_deleted =0 and account_id = 'F0590E45-19AA-4597-A2B5-67553DD7B113')
)
...
where a.account_id = 'F0590E45-19AA-4597-A2B5-67553DD7B113' and a.is_deleted =0 and b.is_deleted =1 and a.r2r_customer_id is not null
...
where a.account_id = 'F0590E45-19AA-4597-A2B5-67553DD7B113' and a.is_deleted =0 and b.is_deleted =1




--COUNTS
select count(*) from #customers where is_deleted =0 and account_id = 'F0590E45-19AA-4597-A2B5-67553DD7B113' --9284
select count(*) from auto_customers.customer.customers (nolock) where is_deleted =0 and account_id = 'F0590E45-19AA-4597-A2B5-67553DD7B113' and  r2r_customer_id is not null  --10925


select count(*) from #vehicles where is_deleted =0 and account_id = 'F0590E45-19AA-4597-A2B5-67553DD7B113' --4493
select count(*) from auto_customers.customer.vehicles (nolock) where is_deleted =0 and account_id = 'F0590E45-19AA-4597-A2B5-67553DD7B113'  --4653



select * from auto_customers.customer.customers a where is_deleted =0 and account_id = 'F0590E45-19AA-4597-A2B5-67553DD7B113' and r2r_customer_id is not null and 
reverse(left(reverse(primary_phone_number),10)) not in (select primary_phone_number from #customers b where is_deleted =0 and account_id = 'F0590E45-19AA-4597-A2B5-67553DD7B113')

select count(*) from auto_customers.customer.customers where is_deleted =0 and account_id = 'F0590E45-19AA-4597-A2B5-67553DD7B113' and  r2r_customer_id is not null and
secondary_phone_number not in (select secondary_phone_number from #customers where is_deleted =0 and account_id = 'F0590E45-19AA-4597-A2B5-67553DD7B113')

--missing valid primary_email due to eliminating duplicate phone numbers
select customer_id,primary_email,primary_email_valid from auto_customers.customer.customers where is_deleted =0 and account_id = 'F0590E45-19AA-4597-A2B5-67553DD7B113' and r2r_customer_id is not null and
primary_email not in (select primary_email from #customers where is_deleted =0 and account_id = 'F0590E45-19AA-4597-A2B5-67553DD7B113') and primary_email_valid =1

   select customer_id,do_not_sms,is_deleted,* 
--update a set is_deleted =0
from auto_customers.customer.customers a (nolock) where account_id = 'F0590E45-19AA-4597-A2B5-67553DD7B113' and r2r_customer_id in (
select owner_id from [18.216.140.206].[r2r_admin].owner.owner b with (nolock) where dealer_id = 48755 and is_deleted =0 and is_lime_opted_in =1
except
select r2r_customer_id from auto_customers.customer.customers a (nolock) where account_id = 'F0590E45-19AA-4597-A2B5-67553DD7B113' and is_deleted =0 and do_not_sms =0 
)
...
update  auto_customers.customer.customers set is_deleted =1 

select *
update a set is_deleted =1
from auto_customers.customer.customers a (nolock) where account_id = 'F0590E45-19AA-4597-A2B5-67553DD7B113' and is_deleted =0 and  
primary_phone_number_valid = 0 and secondary_phone_number_valid =0 and  primary_email_valid =0
